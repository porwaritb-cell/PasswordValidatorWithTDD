...
public class TestRunner {
    ...
    public static void main(String[] a) {
        ...
        check(" 'Abcdef12' vaild ", PasswordValidator.validate("Abcdef12") == true );
        ...
        check(" pw no digit ",PasswordValidator.validate("Abcdrfg") == false);

        // TODO: R6 - มีช่องว่าง -> false
        check(" pw no space ",PasswordValidator.validate("12345 abc ") == false);

        // TODO: boundary อื่นๆ ที่คุณคิดว่าจำเป็น
        check(" pw to symbol ", PasswordValidator.validate("12345@Gmail.com") == true);
